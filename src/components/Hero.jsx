...
const Hero = () => {
  ...
  return (
    <>
      <div className="w-[100%] plr overflow-hidden md:h-[140vh] h-[95vh] ">
        <h1 className='font-bold md:text-7xl leading-[1.1] text-4xl ' >I'm Vedant Vanmore</h1>
        <h1 className='font-bold md:text-6xl text-4xl flex items-center gap-3 ' >Turning idea into impact <span className='rounded-[55px] pt-2 pb-2 md:text-5xl bg text-2xl md:mt-0 mt-[3rem] block w-[21%]  ' ><span className='cursive' ref={typedRef} ></span></span> </h1>
