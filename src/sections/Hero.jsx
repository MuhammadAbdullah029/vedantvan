...
const Hero = ({ aboutRef }) => {
  ...
  return (
    <>
      <div className="w-[100%] plr overflow-hidden md:h-[115vh] h-[115vh] ">
        ...
        <div className='bg w-full md:rounded-[35px] rounded-[15px] md:h-[70vh] lg:h-[60vh] h-[40vh] mt-[5%] relative ' >
          <Scene/>
          <div className="absolute md:bg-white bg-[#F7F6F6] md:w-[30%] md:h-[40%] h-[65%] md:bottom-0 md:right-0 -bottom-[70%] radius rounded-[15px] p-[1.3rem] pb-[.5rem] text-[1rem] ">
            <p className='md:mb-6 mb-3 ' >Delivering efficiency, innovation, and impact through product leadership and AI automation</p>
            <p onClick={() => handleScroll(aboutRef)} className='bg p text-sm md:w-fit block w-full text-center cursor-pointer md:mt-0 mt-6 '  >Discover More</p>
          </div>
          {/* Curves */}
