...
const Tools = () => {
    ...
    return (
        <>
            <div className="w-[100%] md:h-[93vh] h-[130vh] md:p-[3rem] p-[1rem] ">
                <div className="w-[100%] h-[100%] bg-[#F7F6F6] md:rounded-[25px] rounded-[15px] flex md:flex-row flex-col-reverse items-center justify-between p-[1vw] ">
                    ...
                    <div className="right md:w-[49%] w-[100%] md:h-[100%] h-[60%] rounded-[15px] flex flex-col justify-between p-[1rem] ">
                        <h1 ref={headingRef} className='md:text-[5vw] text-4xl font-bold ' >Tools</h1>
                        <p className='md:text-lg text-[4.3vw] leading-[1.2] mb:pb-0 pb-4 ' >I love using tools that will help me get things done faster with accuracy. For automation I use Zapier, Make, Power Automate and many more to build automation workflows that save hours every week. For product/project management and communication I’m comfortable with Trello, Asana, Slack, Jira, Devrev and Notion to keep everything on track without extra meetings.
