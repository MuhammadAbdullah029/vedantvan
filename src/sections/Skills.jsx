      ...
      <div className="w-[100%] h-[100vh] md:p-[3rem] p-[1rem] ">
        <div className="w-[100%] h-[100%] bg-[#F7F6F6] md:rounded-[25px] rounded-[15px] flex md:flex-row flex-col items-center justify-between p-[1vw] ">
          <div className="left md:w-[49%] w-[100%] md:h-[100%] h-[50%] rounded-[15px] flex flex-col justify-between p-[1rem] ">
            <h1 ref={headingRef} className='md:text-[5vw] text-4xl font-bold ' >Skills</h1>
            <p className='md:text-lg text-[4.3vw] leading-[1.2] ' >As an AI Automation Specialist I build automated workflows that save teams massive time and keep operations smooth. As a Product Manager I take projects from idea to launch and make sure features actually deliver. On top of that I can drive growth through faceless content creation, social media account management, influencer marketing, customer success and lead generation, covering both efficiency and user acquisition.</p>
          </div>
